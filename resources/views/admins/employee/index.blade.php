        ...
        <div class="pl-2">
            <div class="mb-6">
                <h1 class="flex items-center gap-3 text-2xl font-bold text-gray-800">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7 text-green-600" viewBox="0 0 36 36"
                        fill="currentColor">
            ...
            <div class="flex justify-between items-center mb-4">
                ...
                <form method="GET" action="{{ route('nhanVien.index') }}" class="flex items-center space-x-2 mb-2">
                    ...
                    <!-- Nút tìm kiếm -->
                    <button type="submit"
                        class="bg-[#D9D9D9] text-gray-800 px-4 py-2 rounded hover:bg-gray-400 transition">
                        Tìm kiếm
                    </button>
                </form>
