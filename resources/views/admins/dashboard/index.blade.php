            ...
            <main class="overflow-auto">
                ...
                <div class="grid grid-cols-4 gap-6 mb-6">
                    <div class="bg-white p-5 rounded shadow">
                        <p class="flex items-center space-x-2 text-gray-500">
                        ...
                        <h2 class="text-2xl font-bold text-gray-800 pl-8">
                            {{ $customers }}
                        </h2>
                    </div>
                    <div class="bg-white p-5 rounded shadow">
                        ...
                        <h2 class="text-2xl font-bold text-gray-800 pl-8">{{ $fields }}</h2>
                    </div>
                    <div class="bg-white p-5 rounded shadow">
                        <p class="flex items-center space-x-2 text-gray-500">
                            ...
                            <span>Đơn đặt hôm nay</span>

                        </p>
                        <h2 class="text-2xl font-bold text-gray-800 pl-8">{{ $bookings }}</h2>
                    </div>
                    <div class="bg-white p-5 rounded shadow">
                        <p class="flex items-center space-x-2 text-gray-500">
                        ...
                        <h2 class="text-2xl font-bold text-green-600 pl-8">{{ number_format($revenue) }}đ</h2>
                    </div>
                </div>
                                    ...
                                    <td class="border text-center px-2">
                                        ...
                                        @if ($item->status == 0)
                                            ...
                                            <form action="{{ route('donDatSan.reject', $item->id) }}" method="POST"
                                                ...
                                                @method('PUT')
                                                <button
                                                    class="bg-[#DC2626] font-semibold text-white px-2 py-2 rounded hover:bg-red-800">
                                                    Từ chối
                                                </button>
                                            </form>
                                        @elseif ($item->status == 1)
