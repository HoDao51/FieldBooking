...
<div class="pl-2 pb-6">
    ...
    <div class="space-y-8">
        @forelse($mostBookedFields as $facilityName => $fields)
            <div id="facility-{{ collect($fields)->first()->Fields->facility_id }}" class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                        @foreach($fields as $index => $stat)
                                <div class="flex gap-4 h-full block relative bg-white border border-gray-200 rounded-xl p-4">
