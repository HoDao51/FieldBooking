<div id="createModal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/40">
    <div class="relative w-full max-w-xl rounded-xl bg-white p-6 shadow-xl">
        <div class="mb-4 flex items-center justify-between">
            <h2 class="text-lg font-semibold text-gray-800">Thêm phương thức thanh toán</h2>
            <button type="button" onclick="closeModal('createModal')" class="text-red-500 hover:text-red-700 text-xl">
        ...
        <form action="{{ route('phuongThucThanhToan.store') }}" method="POST" class="space-y-4">
            @csrf
            <div>
